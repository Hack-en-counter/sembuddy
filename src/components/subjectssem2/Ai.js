  ...
  return (
    <div className="sem">
      ...
      <div data-aos="fade-up" data-aos-delay="150" class="aos-init aos-animate">
        <h1 id="ah">AI for Engineering</h1>
      </div>
      <div class="wrapper">
        <div class="table">
        <div class="r header">
      ...
      <div class="wrapper">
        ...
        <div class="r">
          <div class="cell">Artificial Intelligence by Kevin Knight</div>
          <div class="cell">
            <a href="">Download</a>
          </div>
        </div>
        <div class="r">
          <div class="cell">Neural Networks and Deep Learning A Textbook by Charu C. Aggarwal</div>
          <div class="cell">
            <a href="">Download</a>
          </div>
        </div>
