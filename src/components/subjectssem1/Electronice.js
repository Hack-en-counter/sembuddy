  ...
  return (
    <div className="sem">
      ...
      <div data-aos="fade-up" data-aos-delay="150" class="aos-init aos-animate">
        <h1 id="ah">Emerging Domain of Electronics Engineering</h1>
      </div>
      <div class="wrapper">
        <div class="table">
        <div class="r header">
